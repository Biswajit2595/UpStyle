...
console.log(brand)
  ...
  return (
    ...
    <Button onClick={handleClick} variant="outline" size="md" background="#DE6737">
      Clear All
    </Button>
    ...
    <Heading fontSize="md" fontWeight="bold">
      Sort by Price
       ...
       <div>
         <input type="radio" name="order" value={"asc"} checked={order==="asc"} onChange={handleSort} />
         <label>Ascending</label>
      </div>
       <div>
         <input type="radio" name="order" value={"desc"} checked={order==="desc"} onChange={handleSort} />
